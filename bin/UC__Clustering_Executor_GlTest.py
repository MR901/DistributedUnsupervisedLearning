...
def execute_clust():
    ...
    ## Ignore this iteration if TrainTest is occuring
    if os.path.exists('FlagRaised_TrainingOccurring_DontRunGlTest'):
        print('Flag: "FlagRaised_TrainingOccurring_DontRunGlTest" is raised therfore skipping this predict iteration')
        sys.exit(1)
    ## Raising Flag So That Training Doesn't Occur While This Is Running
    pd.DataFrame().to_csv('FlagRaised_GlTestOccurring_DontRunTrainTest')
    ...
    os.unlink('FlagRaised_GlTestOccurring_DontRunTrainTest')
